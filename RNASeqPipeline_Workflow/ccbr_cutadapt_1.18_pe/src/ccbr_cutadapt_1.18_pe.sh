...
dx-docker run -v /data/:/data kopardev/ccbr_cutadapt_1.18 cutadapt --pair-filter=any --nextseq-trim=2 --trim-n -n 5 -O 5 -q 10,10 -m 35:35 -b file:/data/TruSeq_and_nextera_adapters.consolidated.fa -B file:/data/TruSeq_and_nextera_adapters.consolidated.fa -j `nproc` -o $outfile1name -p $outfile2name $infq1 $infq2
