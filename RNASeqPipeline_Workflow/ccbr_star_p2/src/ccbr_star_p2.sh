...
(>&2 echo "Done listing")
	...
	outStarDmarkBam="out.star.dmar.bam"
	outStarDmarkBai="out.star.dmar.bai"
	outStarDuplic="out.star.duplic"
	outRnaSeqMetricsTxt="out.RnaSeqMetrics.txt"
...
(>&2 echo $gtffile)
	...
	do
		...
		process_job=$(dx-jobutil-new-job run_dedup -iBam=$bam -iRefFlat=$refflat -iRRNAList=$rrnalist --instance-type="mem3_ssd1_x16")
