...
dx-docker run -v /data/:/data kopardev/ccbr_deeptools_3.1.2 plotFingerprint -b $treatmentsortedbam $inputsortedbam --labels $t_label $i_label -p $cpus --skipZeros --plotFile $outpdf
